...
<body>
	...
	<table>
		<c:forEach var="list" items="${list}">
			...
			<tr>
				<td colspan='2'>
					<form action='purchasecancelcommit' method='POST'>
						<input type='hidden' name='purchaseId' value='${list.purchase_id}' /> <input
							type='submit' value='キャンセル' /><br />
					</form>
				</td>
			</tr>
		</c:forEach>
	</table>
	<a href='main.html'>商品検索</a>へ
	<br />
</body>
</html>